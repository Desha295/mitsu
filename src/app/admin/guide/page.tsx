...
import {
  ...
  updateGuide,
  removeGuide,
} from "@/lib/firebase/services/guide.service";
...
function nextOrder(
  items: Array<WithId<GuideSectionDoc>>
): number {
...
/**
 * Freshman Guide management page.
 *
 * Active guide sections automatically create notifications
 * when they are created.
 *
 * When editing an existing section, notification delivery
 * is controlled explicitly through the GuideForm checkbox.
 */
    ...
    <PageContainer className="flex flex-col gap-8">
      <AdminHeader
        title={
          !inForm
            ...
            : isCreating
              ? translate(
                  "admin.guide.form.createHeading"
                )
              : translate(
                  "admin.guide.form.editHeading"
                )
        }
        description={
          !inForm
            ? translate(
                "admin.guide.subheading"
              )
            : undefined
        }
        breadcrumbs={[
            ...
            ? [
                {
                  label: isCreating
                    ? translate(
                        "admin.guide.breadcrumb.new"
                      )
                    : translate(
                        "admin.guide.breadcrumb.edit"
                      ),
                },
              ]
            : []),
      ...
      {!inForm ? (
        items.length > 0 ? (
          ...
          <EmptyState
            icon="Compass"
            title={translate(
              "admin.guide.empty.title"
            )}
            description={translate(
              "admin.guide.empty.description"
            )}
          />
        )
      ) : (
        <GuideForm
          key={
            isCreating
              ? "new"
              : (
                  formTarget as WithId<GuideSectionDoc>
                ).id
          }
          initialValues={
            isCreating
          ...
          submitLabel={
            isCreating
              ? translate(
                  "admin.guide.form.create"
                )
              : translate(
                  "admin.guide.form.saveChanges"
                )
          }
          submittingLabel={translate(
            "admin.guide.form.saving"
          )}
        />
      )}
      ...
      <ConfirmDialog
        ...
        confirmLabel={translate(
          "admin.guide.delete.confirm"
        )}
        confirmingLabel={translate(
          "admin.guide.delete.confirming"
        )}
        cancelLabel={translate(
          "admin.guide.delete.cancel"
        )}
        destructive
        confirming={deleting}
        onConfirm={
